...
def calculer_score(item: dict, q: str, normalisation: dict) -> int:
    ...
    - Bonus source (officiel prioritaire) : 10 points
    ...
    # 6. BONUS SOURCE (10 points - priorité aux officiels)
    type_source = item.get('type_source', '')
    if type_source == 'officiel':
        score += 10  # Les officiels sont prioritaires
    elif type_source == 'blanc':
        score += 5   # Les blancs viennent ensuite
